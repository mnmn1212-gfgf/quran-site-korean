...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(199,231,224,0.08),transparent_26%),radial-gradient(circle_at_82%_18%,rgba(116,191,187,0.06),transparent_20%),radial-gradient(circle_at_20%_80%,rgba(8,24,38,0.22),transparent_24%),linear-gradient(180deg,#01060D_0%,#061220_34%,#081826_68%,#061827_100%)]" />
