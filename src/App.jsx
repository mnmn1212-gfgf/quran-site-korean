...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(199,231,224,0.16),transparent_30%),radial-gradient(circle_at_82%_18%,rgba(79,160,164,0.14),transparent_24%),radial-gradient(circle_at_20%_80%,rgba(13,39,56,0.30),transparent_28%),linear-gradient(180deg,#01060D_0%,#061220_34%,#0D2738_68%,#1F555E_100%)]" />
